...
<div class="min-h-screen flex items-center justify-center px-4 pt-16">
	<div class="max-w-4xl mx-auto text-center">
		...
		<div class="flex flex-col sm:flex-row gap-4 justify-center items-center">
			<a 
				href="#contact" 
				class="glass px-8 py-3 text-white font-semibold rounded-lg hover:bg-white/20 transition-all duration-300 border border-white/30 hover:border-white/50"
				onclick={(e) => {
					e.preventDefault();
			...
			<a 
				href="#projects" 
				class="px-8 py-3 text-white font-semibold rounded-lg border border-white/30 hover:glass transition-all duration-300"
				onclick={(e) => {
					e.preventDefault();
